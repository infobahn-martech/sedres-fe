...
const getAllDispatchNotes = (params) => Gateway.get('/material_management/get_all_dispatch_notes', { params });
...
export default { getAllDispatchNotes, getDispatchNoteById, deleteDispatchNote };
